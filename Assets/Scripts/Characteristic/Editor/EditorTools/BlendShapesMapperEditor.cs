...
public class BlendShapesMapperEditor : EditorWindow
{
    ...
    [MenuItem("Window/DINA Project/Blend Shapes Mapper Editor")]
    public static void ShowWindow()
    {
        EditorWindow.GetWindow<BlendShapesMapperEditor>("Blend Shapes Mapper Editor");
    }
    ...
    private void OnGUI()
    {
        ...
        string blendShapesMapperTooltip = "Blend shapes preset to edit. Use right click -> create -> DINA Project -> BlendShapesMapper in the project window to create a new mapper preset.";
