...
[RequireComponent(typeof(CH_Manager), typeof(Animator))]
public class CH_Gaze : MonoBehaviour
{
    ...
    private void Awake()
    {
        m_CHmanager = gameObject.GetComponent<CH_Manager>();
    ...
    private void InstantiateGazeTarget()
    {
        ...
        m_target.AddComponent<CH_GazeTarget>();
        m_target.GetComponent<CH_GazeTarget>().CHGaze = this;
